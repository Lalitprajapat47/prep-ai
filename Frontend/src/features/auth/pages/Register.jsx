...
const Register = () => {
    const { loading, handleRegistar } = useAuth()
    ...
    const handleSubmit = async (e) => {
        e.preventDefault()
        await handleRegistar({ username, email, password })
        navigate('/')
    }
            ...
            <div className='auth-right'>
                <div className='auth-card'>
                    <div className='auth-card__top'>
                        ...
                        <p className='auth-card__sub'>Start your AI interview prep today</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className='auth-form'>
                        ...
                        <button type='submit' className='auth-submit' disabled={loading}>
                            {loading
                                ...
                                : <>Get Started <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><line x1="5" y1="12" x2="19" y2="12" /><polyline points="12 5 19 12 12 19" /></svg></>
                            }
                        </button>
                    </form>
