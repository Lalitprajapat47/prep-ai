...
const RoadMapDay = ({ day, index }) => (
    <div className='roadmap-day' style={{ animationDelay: `${index * 0.06}s` }}>
...
const Interview = () => {
    ...
    // Animated SVG ring math (r=40, circumference ≈ 251.2)
    const radius = 40
                    ...
                    <div className='match-score'>
                        ...
                        <div className={`match-score__ring ${scoreColor}`}>
                            <svg viewBox="0 0 100 100">
                                <circle className='msr-bg' cx="50" cy="50" r={radius} />
                                <circle
                                    className='msr-fill'
